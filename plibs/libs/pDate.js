...
Date.prototype.monthName = function(short){
    ...
    return Date.MONTHNAMES[this.getMonth()][short];
}

 Date.prototype.format = function (format) {
    var date = this
	var replaceChars = Date._REPLACEMENTS;
...
//Thanks to: https://github.com/jacwright/date.format
Date._REPLACEMENTS = {
	// Day
    d: function () { var d = this.getDate(); return (d < 10 ? '0' : '') + d },
    D: function () { return Date.DAYNAMES[this.getDay()][1] },
    j: function () { return this.getDate() },
    l: function () { return Date.DAYNAMES[this.getDay()][0] },
    ...
    // Month
    F: function () { return Date.MONTHNAMES[this.getMonth()][0] },
    m: function () { var m = this.getMonth(); return (m < 9 ? '0' : '') + (m + 1) },
    M: function () { return Date.MONTHNAMES[this.getMonth()][1] },
